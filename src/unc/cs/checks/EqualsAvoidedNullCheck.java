 ...
 */
@FileStatefulCheck
public class EqualsAvoidedNullCheck extends AbstractCheck {
...
//    public static final String MSG_EQUALS_IGNORE_CASE_AVOID_NULL = "equalsIgnoreCase.avoid.null";
    public static final String MSG_KEY = "equalsAvoidedNull";
...
//                && containsAllSafeTokens(expr)
    ...
    private boolean isCalledOnStringConstant(DetailAST objCalledOn) {
     
      if ( objCalledOn.getType() == TokenTypes.STRING_LITERAL) return true;
      if (isCalledOnStringFieldOrVariable(objCalledOn)) return false;
      return true;
